...
public class Constant  {
    ...
    public static final String CAPITAL_L = "L";
    public static final String SMALL_e = "e";
    public static final String CAPITAL_E = "E";
    public static final String SMALL_b = "b";
    public static final String CAPITAL_B = "B";
    public static final String SMALL_c = "c";
    public static final String CAPITAL_C = "C";
    ...
    public static final String NEARBYCAMPS_MENU = "NEARBYCAMPS";
}
