...
public class MedicalHistoryTest {
  ...
  void upload_medical_history() {
    ...
    medicalHistoryService.file_write(file_to_upload,"Medical1");
    File uploaded_file = new File("C:\\Users\\Sanket2\\IdeaProjects\\MedicalHistory\\group8\\resources\\Uploads\\"+UserSession.userId+"Medical1");
