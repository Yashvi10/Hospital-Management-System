...
public class PharmacyPageTest {
    ...
    void isItemInList_true(){
        ...
        assertEquals(true, pharmacyPage.isItemInList("1"), "The product is not in the list");
    }
    ...
    void isItemInList_false(){
        ...
        assertEquals(false, pharmacyPage.isItemInList("6"), "The product is not in the list");
    }
    ...
    void addItemInCart_true(){
        ...
        assertEquals(true, pharmacyPage.cart.size() > 0);
    }
